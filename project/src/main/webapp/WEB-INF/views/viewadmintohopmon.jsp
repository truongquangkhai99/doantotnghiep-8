        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light-tu nav-header">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/admin/truongthpt">Quản Trường Thpt</a>
              </li>
              <li class="nav-item">
        ...
        <form id ="formhoso" class = "border border-primary m-3 p-3">
         <input name = "id" id = "id" type = "hidden"/>
          <div class="row m-3 p-3">
            <div class="col-3">
              <label>Ngành</label>
              <select class="form-control" id="idNganh" name = "idNganh">
                <option></option>
              </select>
            </div>
            <div class="col-3">
              <label>Mã Tổ Hợp</label>
              <input type="text" class="form-control" name="maToHopMon" placeholder="Mã Tổ Hợp">
            </div>
          </div>
          <div class="row m-3 p-3">
            <div class="col-9">
...
<script type='text/javascript' src='<c:url value="/js/tohopmonadmin.js" />'></script>
</body>
</html>