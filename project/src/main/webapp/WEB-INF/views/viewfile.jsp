      ...
      <body>
        ...
        <div class="container-fluid">
          ...
          <main>
            ...
            <form:form method="POST" action="${pageContext.request.contextPath}/user/uploadFile"
              enctype="multipart/form-data" modelAttribute="myFile" class="border border-primary m-3 p-3">
              <div class="row m-3 p-3">
                <div class="col-12">
                  File : <br />
                </div>
                <div class="col-12">
                  <input type="file" name="multipartFile" required/> <br />
                </div>
                <div class="col-12">
                  <p>
                </div>
