            ...
            <div class="row">
              <div class="col-lg-9 col-xl-9 mx-auto">
                ...
                <form id="formdangky" name="formdangky">
                  ...
                  <div class="form-group mb-3">
                    <input id="email" type="email" name="email" placeholder="Địa chỉ Email" required autofocus=""
                      class="form-control rounded-pill border-0 shadow-sm px-4">
                  </div>
                  <div class="form-group mb-3">
                  ...
                  <div class="text-center d-flex justify-content-between mt-4">
                    <p> Hoặc nếu đã có tài khoản <a href="<c:url value='/login'/>" class="font-italic text-muted">
                        <u>Đăng nhập</u></a></p>
                  </div>
                </form>
              </div>
