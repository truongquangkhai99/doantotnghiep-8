          ...
          <form id="formhoso" class="border border-primary m-3 p-3">
            ...
            <div class="row m-3 p-3">
              <div class="col-3">
                ...
                <input type="number" class="form-control" name="diemtbMonMot"
                  placeholder="Điểm Trung Bình Môn Học Thứ Nhất">
              </div>
              <div class="col-3">
                <label>Điểm Trung Bình Môn Học Thứ Hai</label>
                <input type="number" class="form-control" name="diemtbMonHai"
                  placeholder="Điểm Trung Bình Môn Học Thứ Hai">
              </div>
              <div class="col-3">
                <label>Điểm Trung Bình Môn Học Thứ Ba</label>
                <input type="number" class="form-control" name="diemtbMonBa"
                  placeholder="Điểm Trung Bình Môn Học Thứ Ba">
              </div>
            </div>
            <div class="row m-3 p-3">
              <div class="col-6">
