...
<body>
	...
	<div class="container-fluid">
		<div class="header">
			<nav
				class="navbar navbar-expand-lg navbar-light bg-light-tu nav-header">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item"><a class="nav-link active"
							href="/bts/hoso">Trang Chủ</a></li>
						<li class="nav-item"><a class="nav-link" href="/bts/hoso">Quản
								Lý Hồ Sơ</a></li>

						<li class="nav-item"><c:if test="${not empty user.username}">
		...
		<footer class="page-footer row">
			...
			<div class="col-md-3 bd">
				...
				<a href=""><img src="../img/TLU-map.png" alt="map-thuy-loi"
					style="width: 90%;"></a>
			</div>
		...
		<div class="row copyandmxh">
			...
			<div class="mxh col-md-3">
				<ul>
					...
					<li><a href="https://www.youtube.com/user/daihocthuyloi"
						class="gp">Y</a></li>
				</ul>
			</div>
		</div>
	...
	<script type='text/javascript'
		src='<c:url value="/js/jquery-3.5.1.js" />'></script>
	<script type='text/javascript'
		src='<c:url value="/js/bootstrap.bundle.js" />'></script>
