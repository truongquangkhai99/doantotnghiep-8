    ...
    <main>
      <div class="row" style="margin-top: 30px;">
        <div class="main-l col-md-3">
          <div class="dm">
            ...
            <ul class="menu">
              ...
              <li><a href="/admin/khoa"><span>ADMIN</span></a></li>
              <li><a href="/bts/hoso"><span>BAN TUYỂN SINH</span></a></li>
            </ul>
          </div>
          <!-- box check -->
          <div class="box-check">
            ...
            <div style="PADDING-LEFT:10px;text-align:left;">
              ...
              <table>
                ...
                <tr>
                  <td><input type="radio" name="check" value="Chưa Có"><label for="ctl02_rbl1_1">Chưa Có</label>
                  </td>
                </tr>
              </table>
        ...
        <div class="main-r col-md-9">
          ...
          <ul>
            <li>
              <a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/truong-dai-hoc-thuy-loi-thong-bao-tuyen-11002">Trường
                Đại học Thủy lợi thông báo Tuyển sinh đại học hệ chính quy năm 2020</a>
            </li>
            <li>
              <a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/huong-dan-nhap-hoc-truc-tuyen-14845">Hướng dẫn nhập
                học trực tuyến</a>
            </li>
            <li><a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/huong-dan-thi-sinh-kiem-tra-ho-so-dang-13167">Hướng
                dẫn thí sinh kiểm tra hồ sơ đăng ký xét tuyển online</a></li>
            <li><a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/thong-bao-diem-chuan-dai-hoc-he-chinh-13250">Thông
                báo điểm chuẩn đại học hệ chính quy năm 2020 theo phương thức xét tuyển học bạ đợt 1</a></li>
            <li><a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/thong-bao-ve-viec-xac-nhan-nhap-hoc-va-14854">Thông
                báo về việc xác nhận nhập học và nhập học đối với thí sinh trúng tuyển theo phương thức xét điểm thi
                THPT năm 2021</a></li>
            <li><a href="http://ts.tlu.edu.vn/tuyen-sinh-dai-hoc/thong-bao-ke-hoach-nhap-hoc-he-dai-hoc-14840">Thông
                báo kế hoạch nhập học hệ Đại học chính quy năm 2021</a></li>
